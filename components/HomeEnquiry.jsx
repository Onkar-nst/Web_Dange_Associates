      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          >
            ...
            <p className="text-slate-600 text-lg md:text-xl mt-8 leading-relaxed">
              {language === "en" 
            ...
            <div className="bg-white p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100 relative group overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="relative z-10">
                <div className="space-y-6">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-600 focus:bg-white outline-none transition-all font-medium text-slate-900"
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      onChange={handleChange}
                      className="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-600 focus:bg-white outline-none transition-all font-medium text-slate-900 appearance-none cursor-pointer"
                    >
                ...
                <button 
                  type="submit" 
                  disabled={isLoading}
                  className="w-full mt-10 bg-blue-700 hover:bg-blue-800 text-white font-semibold py-5 rounded-2xl transition-all flex items-center justify-center gap-3 shadow-xl shadow-blue-700/10 group text-lg"
                >
                  {isLoading ? (
                ...
                {status === "error" && (
                  <div className="mt-6 p-4 bg-red-50 border border-red-100 rounded-xl text-red-700 text-sm font-medium text-center animate-in shake duration-500">
